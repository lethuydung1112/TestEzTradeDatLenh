...
public class LenhBanMarProTest extends BaseTest {
    @BeforeClass
    public void Login() {
        lP.setUsername("058C661668");
        lP.setPassword("Fpts@123");
        lP.clickLogin();
        Assert.assertTrue(checkLoginSuccess());
    }

    @Test(dataProvider = "HSX_Sell_MarPro", dataProviderClass = Data_Ban_MarPro.class, priority = 1)
    public void TC1_HSX_Sell_LO(String mack, String khoiluong, String gia) throws InterruptedException {
     ...
     @Test(dataProvider = "HSX_Sell_MarPro",dataProviderClass = Data_Ban_MarPro.class,priority = 2)
    ...
    @Test(dataProvider = "HSX_Sell_MarPro",dataProviderClass = Data_Ban_MarPro.class,priority = 3)
    ...
    @Test(dataProvider = "HSX_Sell_MarPro",dataProviderClass = Data_Ban_MarPro.class,priority = 4)
    ...
    @Test(dataProvider = "HSX_Sell_MarPro",dataProviderClass = Data_Ban_MarPro.class,priority = 5)
    ...
    @Test(dataProvider = "HSX_Sell_MarPro",dataProviderClass = Data_Ban_MarPro.class,priority = 6)
    ...
    @Test(dataProvider = "HSX_Sell_MarPro",dataProviderClass = Data_Ban_MarPro.class,priority = 7)
    ...
    @Test(dataProvider = "HSX_Sell_MarPro",dataProviderClass = Data_Ban_MarPro.class,priority = 8)
    ...
    @Test(dataProvider = "HSX_Sell_MarPro", dataProviderClass = Data_Ban_MarPro.class, priority = 9)
    ...
    @Test(dataProvider = "HSX_Sell_MarPro", dataProviderClass = Data_Ban_MarPro.class, priority = 10)
    ...
    @Test(dataProvider = "HSX_Sell_MarPro", dataProviderClass = Data_Ban_MarPro.class, priority = 11)
    ...
    @Test(dataProvider = "HSX_Sell_MarPro", dataProviderClass = Data_Ban_MarPro.class, priority = 12)
    ...
    @Test(dataProvider = "HNX_LISTED_Sell_MarPro", dataProviderClass = Data_Ban_MarPro.class, priority = 13)
    ...
    @Test(dataProvider = "HNX_LISTED_Sell_MarPro",dataProviderClass = Data_Ban_MarPro.class,priority = 14)
    public void TC14_HNX_LISTED_Sell_MP(String mack, String khoiluong, String gia) throws InterruptedException {
        ...
        @Test(dataProvider = "HNX_LISTED_Sell_MarPro",dataProviderClass = Data_Ban_MarPro.class,priority = 15)
    ...
    @Test(dataProvider = "HNX_LISTED_Sell_MarPro",dataProviderClass = Data_Ban_MarPro.class,priority = 16)
    ...
    @Test(dataProvider = "HNX_LISTED_Sell_MarPro",dataProviderClass = Data_Ban_MarPro.class,priority = 17)
    ...
    @Test(dataProvider = "HNX_LISTED_Sell_MarPro",dataProviderClass = Data_Ban_MarPro.class,priority = 18)
    ...
    @Test(dataProvider = "HNX_LISTED_Sell_MarPro",dataProviderClass = Data_Ban_MarPro.class,priority = 19)
    ...
    @Test(dataProvider = "HNX_LISTED_Sell_MarPro",dataProviderClass = Data_Ban_MarPro.class,priority = 20)
    ...
    @Test(dataProvider = "HNX_LISTED_Sell_MarPro", dataProviderClass = Data_Ban_MarPro.class, priority = 21)
    ...
    @Test(dataProvider = "HNX_LISTED_Sell_MarPro", dataProviderClass = Data_Ban_MarPro.class, priority = 22)
    ...
    @Test(dataProvider = "HNX_LISTED_Sell_MarPro", dataProviderClass = Data_Ban_MarPro.class, priority = 23)
    ...
    @Test(dataProvider = "HNX_LISTED_Sell_MarPro", dataProviderClass = Data_Ban_MarPro.class, priority = 24)
...
@Test(dataProvider = "HNX_LISTED_Sell_MarPro",dataProviderClass = Data_Ban_MarPro.class,priority = 25)
public void TC25_HNX_LISTED_Sell_LO_GuiTungLenh(String mack, String khoiluong, String gia) throws InterruptedException
{
    ...
    @Test(dataProvider = "HNX_LISTED_Sell_MarPro",dataProviderClass = Data_Ban_MarPro.class,priority = 26)
    ...
    @Test(dataProvider = "HNX_LISTED_Sell_MarPro",dataProviderClass = Data_Ban_MarPro.class,priority = 27)
    ...
    @Test(dataProvider = "HNX_LISTED_Sell_MarPro",dataProviderClass = Data_Ban_MarPro.class,priority = 28)
    ...
    @Test(dataProvider = "HNX_LISTED_Sell_MarPro",dataProviderClass = Data_Ban_MarPro.class,priority = 29)
    ...
    @Test(dataProvider = "HNX_LISTED_Sell_MarPro",dataProviderClass = Data_Ban_MarPro.class,priority = 30)
    ...
    @Test(dataProvider = "HNX_UPCOM_Sell_MarPro",dataProviderClass = Data_Ban_MarPro.class,priority = 31)
    ...
    @Test(dataProvider = "HNX_UPCOM_Sell_MarPro",dataProviderClass = Data_Ban_MarPro.class,priority = 32)
    ...
    @Test(dataProvider = "HNX_UPCOM_Sell_MarPro",dataProviderClass = Data_Ban_MarPro.class,priority = 33)
